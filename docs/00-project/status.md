...
- Hai [PR #1 (T-002/T-005 và quyết định nhóm)](https://github.com/quocanwyf/doantotnghiep2nguoi/pull/1) và [PR #2 (T-003/T-006)](https://github.com/quocanwyf/doantotnghiep2nguoi/pull/2) chưa merge. Hai quyết định T-004/T-007 đã được nhóm chốt theo xác nhận của Quốc An; PR đang chờ rà soát văn bản và merge.

...
## T-008 → contract cho T-009/T-010/T-011

[T-008](../01-problem/T-008-requirements.md) thiết kế generic workflow và dẫn từ scenario/BR/FR tới TQ-001–TQ-008; mục 20 là contract cho task sau. T-009 audit candidate dữ liệu/trọng số đã khảo sát trong T-005/T-007 theo đúng capability và phạm vi của chúng, ghi rõ gap hoặc kết luận có điều kiện khi policy profile chưa gán giá trị. T-010 chuyển uncertainty/risk thành profile, protocol, metric và acceptance criteria trước thử; T-011 thu evidence; T-012 phân tích lỗi. Kết quả survey chỉ xác định candidate đáng thử, chưa phải final technical decision. Nếu nghiên cứu phát hiện mâu thuẫn với business baseline hoặc hướng D-001/D-002, nhóm review nguồn và quyết định tương ứng; không sửa business requirement để hợp thức hóa candidate.

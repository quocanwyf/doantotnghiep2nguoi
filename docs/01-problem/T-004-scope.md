...
**Quyết định:** [D-001](../00-project/decisions/T-004-D-001-chon-bai-toan-cua-phong-thi.md). Quốc An xác nhận ngày 2026-09-25 rằng Quốc An và Minh Hy đã chốt đề tài từ T-002. [Logic dẫn tới lựa chọn](DECISION_LOGIC.md) ghi chuỗi suy luận; hai đề xuất cá nhân vẫn được giữ nguyên để đối chiếu.
...
**Đầu ra cho phase 02:** một lượt có mã khai báo và ảnh kiểm tra dẫn tới verification 1:1; rule phòng/ca/giờ và audit là các stage riêng. [D-002](../00-project/decisions/T-007-D-002-chon-huong-khao-sat-t005.md) ghi hướng khảo sát nhóm chọn để thử các phần chưa chắc.

...
- Tóm tắt thay đổi và file chính: docs/01-problem/quoc-an-proposal.md đề xuất một phương án chính: hỗ trợ giám thị xác thực thí sinh tại cửa phòng thi. Tài liệu xác định người dùng, camera, luồng khai báo mã rồi xác minh 1:1, kết quả, ngoại lệ, dữ liệu/quyền dùng, baseline, nhiều hướng tối ưu ứng viên, cách đo và cổng đặc tả nghiệp vụ. Các bối cảnh khác chỉ được nhắc ngắn để đối chiếu. docs/01-problem/quoc-an-t004-scenario.md là kịch bản T-004 giả định theo đề xuất Quốc An, không phải scope hoặc quyết định chung.
- Cách chạy/kiểm tra; kết quả thực tế: không có mã chạy. Đọc đề xuất và đối chiếu với yêu cầu T-002 trên Sheet, docs/01-problem/README.md và docs/00-project/brief.md. Đã đối chiếu bước giám thị trong quy chế thi được Bộ GD&ĐT công bố. Chưa thực nghiệm, thu dữ liệu hay kiểm chứng quyền dùng bộ dữ liệu cụ thể. Kịch bản T-004 chưa thể so sánh với T-003 vì bản của Minh Hy chưa có.

...
- Tóm tắt thay đổi và file chính: docs/01-problem/quoc-an-proposal.md khảo sát bảy use case, gồm xác thực thí sinh tại cửa phòng thi; mỗi use case nối vấn đề nghiệp vụ, camera, 1:1/1:N, đầu ra, ràng buộc, pipeline và hướng đo sơ bộ. Có tiêu chí lọc và cầu nối sang giai đoạn 02.
...
- Quyết định hoặc giả định liên quan: đây là đề xuất riêng của Quốc An; chưa chọn use case, dữ liệu, model, metric hay thuật toán cho nhóm. G là hướng Quốc An ưu tiên kiểm tra tiếp, với thí sinh khai báo mã rồi xác minh 1:1; B, C và D là phương án đối chiếu. Đây không phải kết luận T-004.

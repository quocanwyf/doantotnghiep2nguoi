...
- Tóm tắt thay đổi và file chính: docs/01-problem/quoc-an-proposal.md đề xuất một phương án chính: hỗ trợ giám thị xác thực thí sinh tại cửa phòng thi. Tài liệu T-002 xác định người dùng, camera, luồng khai báo mã rồi xác minh 1:1, kết quả và ngoại lệ. Khảo sát dữ liệu, baseline, hướng tối ưu và cách đo được tách sang docs/02-survey/quoc-an-survey.md (T-005). T-004 chưa có tài liệu scope hoặc quyết định; tệp kịch bản T-004 giả định đã được bỏ.
- Cách chạy/kiểm tra; kết quả thực tế: không có mã chạy. Đọc đề xuất và đối chiếu với yêu cầu T-002 trên Sheet, docs/01-problem/README.md và docs/00-project/brief.md. Đã đối chiếu bước giám thị trong quy chế thi được Bộ GD&ĐT công bố. Chưa thực nghiệm, thu dữ liệu hay kiểm chứng quyền dùng bộ dữ liệu cụ thể. Chưa thể so sánh phương án với T-003/T-006 vì các bản của Minh Hy chưa có.

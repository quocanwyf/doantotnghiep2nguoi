...
- **Đầu ra:** [README giai đoạn 02](../02-survey/README.md) dẫn đến bốn file theo thứ tự: [phân rã task](../02-survey/T-005-quoc-an-task-decomposition.md), [khảo sát dataset](../02-survey/T-005-quoc-an-datasets.md), [khảo sát model/phương pháp](../02-survey/T-005-quoc-an-models.md), [thiết kế thí nghiệm](../02-survey/T-005-quoc-an-experiments.md). Bản khảo sát một file cũ đã được thay thế theo yêu cầu Quốc An.
...
- **Cách kiểm tra:** đọc liên kết và nguồn chính thức trong bốn tài liệu; so stage với use case [T-002](../01-problem/T-002-quoc-an-proposal.md); kiểm tra rằng không có ký hiệu/lựa chọn cũ được dùng làm điểm xuất phát. Khi thực nghiệm, xác minh lại file, giấy phép, trọng số, protocol và hash rồi tái lập trên cùng split/phần cứng.
